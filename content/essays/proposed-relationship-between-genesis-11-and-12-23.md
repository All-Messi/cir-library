...
B.	Bara’ (בָּרָא) means to create a new kind of thing. Referring to the universe, the word implies creation from nothing.

C.	Taking “in the beginning” (בְּרֵשִּׁית) as a Hebrew construct form creates a more complex syntax in Hebrew grammar that does not match as easily the simple style in the rest of Genesis 1-2. (cp. Deuteronomy 24:1-4, however)
