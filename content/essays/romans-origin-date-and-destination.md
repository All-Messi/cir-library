...
In Rome (ἐν Ρόμῃ) is omitted at 1:7 and 15 in a few sources. In 1:7 it is omitted from Gg, Origen, and minuscules 1739 and 1908. The destination is omitted from Gg in 1:7. Consequently, in only one manuscript, the bilingual Gg, are the destination notes omitted altogether. Since all manuscripts except Gg contain indications of destination, there is no problem about where the epistle was originally sent, whatever may be said for circulation theories that attempt to account for the shorter forms of the epistle.  Those theories pertain only to the last two chapters.
