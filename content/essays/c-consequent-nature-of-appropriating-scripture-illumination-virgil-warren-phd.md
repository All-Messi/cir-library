...
2. The effect of the view of scripture on interpretation

The nature of scripture determines what procedures fit with interpreting it. The reliability of the record can affect what a passage means and especially how we get to it. Since this “library” came from many authors over many centuries, assuming the consistency of its parts is a presupposition necessary for understanding them as parts of the same whole.

a. The accuracy of scripture

The harmony and reliability of scripture allows combining insights from various places. The procedure works if all the writers are speaking about parts of the same whole. Otherwise, we would have to limit what material we could bring to bear on the meaning of a text. We would have to limit ourselves to writers from the same time and place, to books by the same author, to the immediate book, or even to one segment of a book in cases of assumed source documents; we would have no reason to believe in a common understanding. It would be artificial to take the writings of several teachers in even the same Christian college and use insights from one to clarify statements by another. Without assuming the common ultimate authorship by the Spirit, there would be less legitimacy in combining information from the more than forty authors, spread over 1500 years, writing from times of apostasy and a wide variety of circumstances. Since many scholars do not suppose the harmony of scripture, they object to harmonizing as artificial. At best, what is common to all the writers constitutes non-negotiable aspects of the Christian faith; items peculiar to one writer become more negotiable.

Supposing that a writing is not true makes it harder to understand. Readers hurry through it with less motivation to clear up ambiguities and work out apparent contradictions. Since they have no reason to believe the parts do harmonize, they may caricature pieces that do not strike them as likely. Exaggeration compounds the interpretation problem by introducing foreign factors. People with an anti-supernatural bias stand at odds with much of biblical content because they discount its manner of origin. Supernatural assistance is required for getting a harmonious message from different authors under diverse circumstances over so much time.

In relation to predictive prophecy especially, the anti-supernatural bias may cause readers to misidentify the referent of the prediction. They eliminate any fulfillment that could not have been guessed ahead of time. Naturalistic bias lies behind treating Old Testament predictions as “realized eschatology,” that is, prophecy written after the fact but put in the form of prediction to emphasize the utter certainty of why it occurred.
...
Is scripture, particularly the New Testament, a law code, a historical document, a handbook, a manual? Do we expect it to specify behavior and beliefs at a relatively detailed level, or do we anticipate finding principles for answering life’s questions? Is the New Testament to the church what the Old Testament was to Israel or what the Koran is to Islam?

Considering the New Testament to be for the church what the Old Testament was for Israel requires remembering that they are different covenants and different kinds of covenants. Otherwise, we carry the correlation too far and end up reading the New Testament as a body of law rather than as an interpersonal system. If it is a constitution like the Torah and the Koran, its statements take on a legal quality, which gives greater rigidity to language and its ideas. (See “Interpretation of Classes of Literature.”) “Legal methodology” adjusts the interpretation process by giving (a) silence greater power to prohibit. A body of law is designed to take care of practical situations people typically face. (See “Confusing Precedent and Example.”)

A legal framework gives (b) precedent greater value. We more likely assume that apostles did what they did because they were specifically directed to do so.
...
**The modern creationist movement, as helpful as it has been in the broad perspective, unfortunately affords several examples of taking “could be’s” for “must be’s.” Much of what the movement says is conceivable, but interpretations of specific passages necessary are not always necessary.

d. 	From the beginning (see “Great Commission”), the gospel was intended to be trans-cultural. People who work across languages speak more loosely because fine nuances get lost in translation. The Greek record in the gospels was translated from Aramaic discourses, which means that close wording is not as likely.
...
Because materials from different passages differ in their degree of clarity, (4) we must take the unclear in light of the clear and the situational in light of the general. Poetic, prophetic, and historical materials are taken in light of didactic materials. (See “Confusing Example and Precedent.”) Understanding the ambiguous in light of the clear keeps the burden of proof on the affirmative. An idea conceivably associated with a text often cannot be disproved, but that does not make it true.

Because the total information on some biblical topics is not clear, (5) the role of hermeneutics is restrictive more than positive. Instead of identifying specifics, it establishes boundaries. In some doctrinal matters, scripture does not give sufficient information to establish precise ideas. We have to content ourselves with drawing circles within which the truth must fall and allow opinion to operate on choices within that circle. We can say what something does not mean, but not what it does mean. Interpretation serves only to establish latitude within orthodoxy.

Biblical-systematic interpretation contrasts with (a) systematic deduction from some first principle (scholastic methodology), and with (b) biblical positivism, where each item is supposedly affirmed directly and clearly in a way that interpreters are not responsible for dilemmas created by their exegesis. Taking responsibility for dilemmas would supposedly put human reason above scripture! Such a notion puts human reason above scripture anyway by hanging with dilemmas created by human reason in the exegetical process. Dilemmas are clues that exegesis has failed. “Biblical positivism” loses wholeness and limits us to what we can know inductively. Without systematic advantage, our work is limited to individual texts and reliance on word meanings. That leaves us open to proof texting from passages that others handle differently, and gives us no recourse for getting behind the alternatives by appealing to the big picture.

A more wholesome, though inadequate, kind of biblical positivism is to take as true in principle every statement the Bible without necessarily understanding what they mean. That leaves interpretation in limbo and reduces the practical use of the message.

The Bible is also not like a repair manual. We do not bring our question to the Bible expecting to find a specific answer. That expectancy would foster interpreting the Bible as a book of disconnected sections; it treats verses like proverbs. Verse and chapter divisions reinforce that inclination, particularly if verses appear separately rather than in paragraphs.

Biblical-systematic interpretation contrasts with (c) positing a hypothesis and amassing data to substantiate it. It does not take advantage of the reciprocation between parts and whole that enables adjusting the whole by the parts and vice versa. (See “Pitfalls of Interpretation.”)
...
The positive burden of proof leads to not expecting special principles for biblical interpretation. Three reasons, however, incline people toward that idea:

(1) to exonerate New Testament teaching based on Old Testament texts seemingly irrelevant to New Testament applications. Since normal principles do not justify the application, peculiar ones are proposed. The New Testament, however, does not use artificial “interpretations” of Old Testament passages. It may use an Old Testament text merely to picture the New Testament writer’s idea, not to prove it. In such instances people do not get why the author cites the passage; they misinterpret the writer’s interpretation. In other cases, they miss something actually in the Old Testament text itself or implied by it.

(2) to get scripture to conform to our presuppositions

(3)  to match God’s omniscience; he can intend more by what he says

than a human person can.

a. Double reference

One modern impetus for double reference stems from dispensationalism, which anticipates an earthly millennial kingdom as per Old Testament predictions. The spiritual aspect of Messiah’s kingdom has already been infused into history via the church; the political overlay is yet to be “added.” The “second” fulfillment is the “rest” of the prediction. This theology of the kingdom parallels the Pharisees’ expectations, which Jesus had to combat during his ministry, as well as the Judaizers’ teachings, which Paul disputed in his missionary efforts to Gentiles. The New Testament gives us no reason to anticipate any additional fulfillment of kingdom prophecies beyond what its writers have already identified as fulfillments. If there is more, there is no way to tell that yet; we would have to “wait and see.”
...
We distinguish between what a passage means, what it could mean, what it is analogous to, what it can be applied to, and what subsequent implications and levels of generalization it might have. Analogy and application do not pertain to the meaning of a statement; those come from a reader’s sanctified creativity. A text does not mean everything it could mean, but what the author intended it to mean in this case. Trying to make a word carry all its meanings in the same instance is called “illegitimate totality transfer.”
...
Regarding supernatural enablement, we must distinguish (1) understanding and believing; (2) understanding and being interested in, seeing the need for, sensing the importance of what we understand; (3) understanding and understanding fully, especially experiential matters. The same problems exist in other than Christian matters as well.

e. 	Literal taking precedence over figurative interpretation
...
a. Authority means submitting our interpretation to someone other than the author. Correct understanding does not rest on the interpreters themselves.

b. License means not submitting our interpretation to someone besides the

author.

c. Private judgment means submitting our interpretation only to the author. The point is that in principle we are not free to make a statement mean whatever we want. We cannot always be sure that we have understood the text the way the author meant it, but it is important to establish the correct goal.

7. Intelligibleness of the Bible

a. What it means

(1) The Bible is appropriate to people as God made them. [nature of mankind] [perspicuity]

(2) The Bible follows the rules of understanding natural to human language in contrast to the notion of mystery, to having peculiar principles for interpreting biblical materials, to supposing multiple meanings, or to supposing a special code known only to special people. [nature of language] [perspicuity]

(3) What we need to know can be known through a natural reading of scripture in contrast to the idea that everything is treated at least implicitly in scripture. [nature of scripture] [sufficiency]

b. What it does not mean

(1) That all matters are equally clear

(2) That there are no difficult passages or concepts

(3) That there are no passages with more than one interpretation that
...
(5) that we have to understand everything. Some matters are more central to the faith than others are; primary concerns are clear enough, and the others may come with time. Incidentals may never need to be worked out.

c. What it stands over against

(1) needing supernatural regeneration to understand the Bible (man)

(2) yielding to external authority for guiding interpretation (authority)
