...
πᾶσα γραφὴ θεόπνευστος καὶ ὠφέλιμος
...
It is easiest to eliminate writing because the context is talking about the holy writings/scriptures rather than every writing there is.

Omitting the commas would make God-breathed a restrictive expression, which would fit with writing; but since that is eliminated, we do not take a restrictive meaning for scripture. Though grammatically possible, the idea is foreign to the setting here: Paul is not contrasting within scripture but between scripture and no scripture, so to speak.

Placing is before God-breathed is most natural because it allows and to have its most normal value, especially since it stands between grammatically equal and conceptually parallel entries.

Taking #2 and #3 in combination, we conclude that God-breathed is non-restrictive (hence, commas) with is placed afterwards or that it is a predicate adjective parallel to profitable with is ahead of it.
