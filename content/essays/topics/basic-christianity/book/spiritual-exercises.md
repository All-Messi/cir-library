...
Sanctification process is like education; change (<em>i.e.,</em> learning) takes place in doing.
...
Whereas many wholesome activities have some value for spiritual development, the ones that occur with people are most effective, because people are social creatures: <em>“It is not good that man should be alone”</em> (Genesis <strong><sup>2</sup></strong>:18).
...
c.	Interpersonal avoids both extremes by cooperation in the form of reciprocation (<em>vs</em>. parallelism: A does not do one part and B do another to produce the result in parallel).

God gets the credit if we succeed; we take the blame if we fail.


2.	Fits in with sin as habit (<em>vs.</em> depraved being)
...
Acts <strong><sup>20</sup></strong>:35: <em>“It is more blessed to give than to receive.”</em>
